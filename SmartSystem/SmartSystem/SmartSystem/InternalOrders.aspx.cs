    ...
    public partial class InternalOrders : System.Web.UI.Page
    {
        ...
        protected void btnAddNewOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblOrderErr.Text = "لم يتم أختيار العميل ";
        ...
        protected void btnAddNewCustomer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (cust != null)
                    {
                        LblError.Text = "رقم العميل موجود بالفعل ";
                        LblError.Visible = true;
                        LblError.ForeColor = System.Drawing.Color.Red;
                    }
                    else
                    {
                        ...
                        LblError.Text = "تم أضافة العميل الجديد بنجاح";
                        LblError.Visible = true;
                        ...
                        Customer.Items.Add("أختار العميل");
                        Customer.DataBind();
                    }
                }
            }
