<%@ Page Title="" Language="C#" MasterPageFile="~/SmartShutter.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="DeadReport.aspx.cs" Inherits="SmartSystem.DeadReport" %>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-3">
                                                                        ...
                                                                        <asp:ImageButton ID="btnExportStoreExcel" runat="server" CssClass="btnaction float-right" Width="50px" Height="50px" ImageUrl="~/Images/excel.png" OnClick="btnExportStoreExcel_Click" />
                                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="card card-danger card-outline">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" Width="100%">
                                                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                                            <Columns>
                                                                                <asp:BoundField DataField="StoreName" HeaderText="Store" SortExpression="StoreName" />
                                                                                <asp:BoundField DataField="MaterialNo" HeaderText="Code" SortExpression="MaterialNo" />
                                                        ...
                                                        <div class="card card-success card-outline">
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-3">
                                                                        <asp:ImageButton ID="btnGetSupplierDataPDF" CssClass="btnaction float-right" Width="50px" Height="50px" runat="server" ImageUrl="~/Images/pdf.png" OnClick="btnGetSupplierDataPDF_Click" />
                                                                        <asp:ImageButton ID="btnGetSupplierDataExcel" runat="server" CssClass="btnaction float-right" Width="50px" Height="50px" ImageUrl="~/Images/excel.png" OnClick="btnGetSupplierDataExcel_Click" />
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        <asp:GridView ID="GridSupplierData" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource4" ForeColor="#333333" GridLines="None" Width="100%" AllowPaging="True" AllowSorting="True">
                                                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                                            <Columns>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                                                                            CellPadding="4" DataSourceID="SqlDataSource5" ForeColor="#333333" GridLines="None" Width="100%" AllowPaging="True" AllowSorting="True">
                                                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                                            <Columns>
                                                                                <asp:BoundField DataField="StoreName" HeaderText="Store" SortExpression="StoreName" />
                                                                                <asp:BoundField DataField="MaterialNo" HeaderText="Code" SortExpression="MaterialNo" />
                                                                        ...
                                                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:SmartShutterConnectionString %>" SelectCommand="SELECT Stores.StoreName, Materials.MaterialNo, Materials.MaterialName, DeadMaterials.Height, DeadMaterials.Width, DeadMaterials.Quantity, DeadMaterials.Notes, DeadMaterials.ActionDate, DeadMaterials.UserName, Supplier.Name FROM Materials INNER JOIN Supplier ON Materials.SupplierID = Supplier.SupplierID INNER JOIN DeadMaterials ON Materials.ID = DeadMaterials.MaterialID INNER JOIN Stores ON DeadMaterials.StoreID = Stores.ID WHERE (Materials.TypeID IN (SELECT ID FROM SubCategories WHERE (CategoryID = @categoryID)))">
                                                                            <SelectParameters>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="card card-warning card-outline">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        <asp:GridView ID="GridSubCategory" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource3" ForeColor="#333333" GridLines="None" Width="100%" AllowPaging="True" AllowSorting="True">
                                                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                                            <Columns>
                                                                                <asp:BoundField DataField="StoreName" HeaderText="Store" SortExpression="StoreName" />
                                                                                <asp:BoundField DataField="MaterialNo" HeaderText="Code" SortExpression="MaterialNo" />
                                                                        ...
                                                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SmartShutterConnectionString %>" SelectCommand="SELECT Stores.StoreName, Materials.MaterialNo, Materials.MaterialName, Supplier.Name AS Supplier, DeadMaterials.Height, DeadMaterials.Width, DeadMaterials.Quantity, DeadMaterials.Notes, DeadMaterials.ActionDate, DeadMaterials.UserName FROM Materials INNER JOIN Supplier ON Materials.SupplierID = Supplier.SupplierID INNER JOIN DeadMaterials ON Materials.ID = DeadMaterials.MaterialID INNER JOIN Stores ON DeadMaterials.StoreID = Stores.ID WHERE (Materials.TypeID = @categoryID)">
                                                                            <SelectParameters>
