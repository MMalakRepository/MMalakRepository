<%@ Page Title="" Language="C#" MasterPageFile="~/SmartShutter.Master" AutoEventWireup="true" CodeBehind="PrintMaterialAddition.aspx.cs" Inherits="SmartSystem.PrintMaterialAddition" %>
                    ...
                    <div class="container-fluid">
                        <form runat="server">
                            ...
                            <rsweb:ReportViewer ShowPrintButton="true" ID="ReportViewer1" runat="server" Width="80%" Height="700px" BorderStyle="Solid" BorderWidth="2px" SizeToReportContent="True">
                                <LocalReport ReportPath="./Reports/MaterialAddition.rdlc" EnableExternalImages="true">
                                </LocalReport>
                            </rsweb:ReportViewer>
                        </form>
                    </div>
